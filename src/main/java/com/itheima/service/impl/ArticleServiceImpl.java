...
public class ArticleServiceImpl implements IArticleService {
    ...
    public void publish(Article article) {
        ...
        article.setAllowComment(true);//设置值
        redisTemplate.opsForValue().set("article_" + article.getId(),article);//写入redis
    }
    ...
    @Override
    public List<Article> findByLike(String title) {
        return articleMapper.findByLike(title);
    }
